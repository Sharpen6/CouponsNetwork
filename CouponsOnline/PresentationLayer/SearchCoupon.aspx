...
<body>
    ...
    <div id="home" class="mainBox large" style="display:block">
        ...
        <div>
            ...
            <asp:DropDownList ID="DropDownListCities" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownListCities_SelectedIndexChanged">
        ...
        <div>
            <asp:Label ID="Label3" Width="45%" runat="server" Text="OR, Select coupon by interests"></asp:Label>
             ...
             <asp:checkboxlist id="DropDownListInterests" SelectMethod="" Width="45%" runat="server" SelectionMode="Multiple" AutoPostBack="True" OnSelectedIndexChanged="DropDownListInterests_SelectedIndexChanged" />
        </div>
